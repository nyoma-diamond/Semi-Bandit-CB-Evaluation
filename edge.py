...
class Edge:
    ...
    def single_prob(self, e): # probability that an edge e is chosen by exploiting distribution
    ...
    def coocurence_mat(self):
        ...
        for e_1 in range(self.E):
            ...
            for e_2 in range(e_1+1,self.E):
                mat[e_1,e_2] = self.H[0, int(self.edge_node[e_1,0])] * self.w[e_1] * self.H[int(self.edge_node[e_1,1]),int(self.edge_node[e_2,0])] * self.w[e_2] * self.H[int(self.edge_node[e_2,1]),self.N-1] / self.H[0,self.N-1]
